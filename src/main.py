...
if __name__ == "__main__":
    ...
    parser.add_argument('group_id', type=int, help='ID группы студентов в Redmine, например, 9')
    ...
    if err_code != 0:
        ...
        sh.shedule_lab(ns.num, ns.duration, ns.tracker, ns.group_id, ns.mode, config)
