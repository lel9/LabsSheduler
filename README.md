...
2. Запустить скрипт main.py, передав в качестве параметров номер лабораторной (название поддиректории в директории /path/to/labs) и количество дней, отводимых на её выполенение, например
```
